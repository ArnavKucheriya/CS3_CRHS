...
public class TrieGrader {
    ...
    public static void main(String[] args) {
        ...
        try{
        	Scanner outFile = new Scanner(new File("output.out"));
        	Scanner ansFile = new Scanner(new File("answer.txt"));
        	while(outFile.hasNextLine()){
				if(outFile.nextLine().equals(ansFile.nextLine())==false){
					System.out.println("check the out file for your error!");
					return;
				}
        	}
        }catch(Exception e){
